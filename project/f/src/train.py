...
from utils.utils import seed, evaluate_policy, ReplayBuffer
from utils.env import launch_env
from gym_duckietown.envs import DuckietownEnv
from wrappers.wrappers import NormalizeWrapper, ImgWrapper, DtRewardWrapper, ActionWrapper, ResizeWrapper
...
def _train(args):
    ...
    while total_timesteps < args.max_timesteps:
        ...
        if total_timesteps < args.start_timesteps:
            ...
            action = np.array([0.1,0.1])#policy.predict(np.array(obs))
